...
class BasePointNet(nn.Module):
    """
    BasePointNet is a neural network module for processing point cloud data.
    Based on the whitepaper "PointNet: Deep Learning on Point Sets for 3D Classification and Segmentation" by Qi et al.
    """

    def __init__(self, point_dimension, return_local_features=False):    #Base neural network
...
class ClassificationPointNet(nn.Module):
    """
    ClassificationPointNet is a neural network model for point cloud classification.
    Based on the whitepaper "PointNet: Deep Learning on Point Sets for 3D Classification and Segmentation" by Qi et al.
    """

    def __init__(self, num_classes, dropout=0.3, point_dimension=3):         #Base neural network
...
class SegmentationPointNet(nn.Module):
    """
    SegmentationPointNet is a neural network model for point cloud segmentation.
    Based on the whitepaper "PointNet: Deep Learning on Point Sets for 3D Classification and Segmentation" by Qi et al.
    """

    def __init__(self, num_classes, point_dimension=3):      #Base neural network
